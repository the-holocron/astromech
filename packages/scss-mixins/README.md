# Arone [![npm](https://img.shields.io/npm/v/@theholocron/arone)](https://www.npmjs.com/package/@theholocron/arone)
...
```shell
$ npm install --save-dev @theholocron/arone
```
...
```scss
// include all utilities with 'arone' as the namespace
// calls all mixins and will include in CSS output
@use "@theholocron/arone/src" as arone;

// include only a specific group of mixins
@use "@theholocron/arone/src/box-model" as *;
// call the mixins from this group
@include background-color();
@include border();

// use only a specific mixin
@use "@theholocron/arone/src/box-model/border-radius" as *;
...
* [**utilities**](./src/utilities/README.md) - these are miscellaneous utilities that affect hover, focus or active states, responsiveness and `nth-child` selectors.

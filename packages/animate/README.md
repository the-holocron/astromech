# Arthree [![npm](https://img.shields.io/npm/v/@theholocron/arthree)](https://www.npmjs.com/package/@theholocron/arthree)
...
```shell
$ npm install --save-dev @theholocron/arthree
```

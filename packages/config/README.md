# Configuration [![npm](https://img.shields.io/npm/v/@theholocron/config)](https://www.npmjs.com/package/@theholocron/config)
...
```shell
$ npm install --save-dev @theholocron/config
```
...
The best way to find out what's available is to check out the source code or take a look at the [README](./src/README.md) within the source directory.  More documentation and a possible site to explore are set to come.

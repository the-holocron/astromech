# Arfive [![npm](https://img.shields.io/npm/v/@theholocron/arfive)](https://www.npmjs.com/package/@theholocron/arfive)

This utility droid provides a set of single-purpose mixins for writing (S)CSS within the Galaxy.
...
```scss
// include all animations with 'arfive' as the namespace
